...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glClearColor(.0f, .0f, 0.0f, 1.0f); // cor de fundo
...
GLfloat *generateVertices(int n)
{
	GLfloat *ret = (GLfloat *)calloc(n * 3, sizeof(GLfloat));
...
int setupGeometry()
{
	...
	GLint n = N;
	GLfloat *vertices = generateVertices(n);
